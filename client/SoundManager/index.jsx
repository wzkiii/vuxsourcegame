class SoundManager {
	...
	preload () {
        ...
        this.game.load.audio('oegoleiro','/sounds/oegoleiro.mp3');
	}
	...
	create () {
		...
		this.kick = this.game.add.audio('kick', 0.5);
		this.sounds.push(this.kick);

        this.trave = this.game.add.audio('oegoleiro');
        this.sounds.push(this.trave);
	...
	startPublic() {
		this.public1.volume =  null
		this.public1.fadeIn(100, true);
	}
